...
\caption{(\#tab:e\_coeffs)Mean SMD by study modality, data-collection method, and type of dependent measure.}\tabularnewline
\toprule()
...
We also conducted an exploratory analysis of potential publication bias. It was unclear how we might expect publication biases to manifest themselves, given that there is some possibility of notoriety for either showing \emph{or} failing to show differences between online and in-person testing.
