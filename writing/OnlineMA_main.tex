...
Nguyen, Fitzpatrick, and Floccia (n.d.) & 2 & Verb & Mod & 22 \\
...
Nguyen, D., Fitzpatrick, N., \& Floccia, C. (n.d.). \emph{ADAPTING LANGUAGE DEVELOPMENT RESEARCH PARADIGMS TO ONLINE TESTING}.
...
Steffan, A., Zimmer, L., Arias-Trejo, N., Bohn, M., Ben, R. D., Flores-Coronado, M. A., et al.others. (2023). \emph{Validation of an open source, remote web-based eye-tracking method (WebGazer) for research in early childhood}.
