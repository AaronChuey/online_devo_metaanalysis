...
We also examined which combinations of methods and measures tended to yield the strongest and weakest effect sizes relative to their in-person counterparts. Although we cannot draw any strong conclusions about any possible multi-way interaction between study modality, data-collection method, and dependent measure due to our relatively small sample size, unmoderated studies with looking measures yielded the noticeably weakest effect sizes compared to their in-person counterparts, an average difference of `r grouped_calc$SMD[1] - grouped_calc$SMD[5]` (See Table \@ref(tab:modmeans)). In contrast, moderated online studies with looking and verbal measures as well as unmoderated online studies with verbal measured all differed by less than .2 SMD from their in-person counterparts. 
...
Additionally, we conducted an exploratory analysis of potential publication bias. It was unclear how we might expect publication biases to manifest themselves, given that there is some possibility of notoriety for either showing *or* failing to show differences between online and in-person testing.
