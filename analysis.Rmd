...
blank_plot = ggplot(d_diff, aes(x = short_cite, y = d_diff)) + 
  geom_point(alpha=0) +
  coord_flip() +
  scale_x_discrete(labels = c("Paper 15", "Paper 14", "Paper 13", "Paper 12", "Paper 11", "Paper 10", "Paper 9", "Paper 8", "Paper 7", "Paper 6", "Paper 5", "Paper 4", "Paper 3", "Paper 2", "Paper 1")) +
  geom_hline(yintercept = 0, lty = 2) + 
