...
#all data
regtest(x=d_calc, vi=d_var_calc, data=d_calc)

regtest(x=d_calc, vi=d_var_calc, data=d_calc %>% filter(expt_condition == "online"))

regtest(x=d_calc, vi=d_var_calc, data=d_calc %>% filter(expt_condition == "in-person"))
...
vanilla_plot = ggplot(d_diff, aes(x = short_cite, y = d_diff)) + 
  geom_point(alpha = 1, width = .25, height = .25, size = 4) +
  coord_flip() +
  geom_hline(yintercept = 0, lty = 2) + 
  aes(x=reorder(short_cite,-d_diff, sum)) +
  scale_x_discrete(labels = c("Paper 23","Paper 22","Paper 21","Paper 20","Paper 19","Paper 18","Paper 17","Paper 16","Paper 15", "Paper 14", "Paper 13", "Paper 12", "Paper 11", "Paper 10", "Paper 9", "Paper 8", "Paper 7", "Paper 6", "Paper 5", "Paper 4", "Paper 3", "Paper 2", "Paper 1")) +
...
om_plot = ggplot(d_diff, aes(x = short_cite, y = d_diff)) + 
  geom_point(aes(color = Online_Method), alpha = 1, width = .25, height = .25, size = 4) +
  coord_flip() +
  geom_hline(yintercept = 0, lty = 2) + 
  aes(x=reorder(short_cite,-d_diff, sum)) +
  scale_x_discrete(labels = c("Paper 23","Paper 22","Paper 21","Paper 20","Paper 19","Paper 18","Paper 17","Paper 16","Paper 15", "Paper 14", "Paper 13", "Paper 12", "Paper 11", "Paper 10", "Paper 9", "Paper 8", "Paper 7", "Paper 6", "Paper 5", "Paper 4", "Paper 3", "Paper 2", "Paper 1")) +
...
m_plot = ggplot(d_diff, aes(x = short_cite, y = d_diff)) + 
  geom_point(aes(color = Measure), alpha = 1, width = .25, height = .25, size = 4) +
  coord_flip() +
  geom_hline(yintercept = 0, lty = 2) + 
  aes(x=reorder(short_cite,-d_diff, sum)) +
  scale_x_discrete(labels = c("Paper 23","Paper 22","Paper 21","Paper 20","Paper 19","Paper 18","Paper 17","Paper 16","Paper 15", "Paper 14", "Paper 13", "Paper 12", "Paper 11", "Paper 10", "Paper 9", "Paper 8", "Paper 7", "Paper 6", "Paper 5", "Paper 4", "Paper 3", "Paper 2", "Paper 1")) +
...
a_plot = ggplot(d_diff, aes(x = short_cite, y = d_diff)) + 
  geom_point(aes(color = Age), alpha = 1, width = .25, height = .25, size = 4) +
  coord_flip() +
  geom_hline(yintercept = 0, lty = 2) + 
  aes(x=reorder(short_cite,-d_diff, sum)) +
  scale_x_discrete(labels = c("Paper 23","Paper 22","Paper 21","Paper 20","Paper 19","Paper 18","Paper 17","Paper 16","Paper 15", "Paper 14", "Paper 13", "Paper 12", "Paper 11", "Paper 10", "Paper 9", "Paper 8", "Paper 7", "Paper 6", "Paper 5", "Paper 4", "Paper 3", "Paper 2", "Paper 1")) +
